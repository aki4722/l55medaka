...
class employeeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('business.employee.index', compact('employee'));
    }
    ...
    {
        return view('business.employee.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('business.employee.show', compact('employee'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('business.employee.edit', compact('employee'));
    }
